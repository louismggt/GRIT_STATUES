...
nain_de_merde = Statue.create!(name: "nain_de_merde",user: julie , category: CATEGORIES.sample, surface: 15, description:  "entrée de gamme", price: 5, photo: "https://cdn.mycrazystuff.com/15836/nain-de-jardin-i-m-sexy-an-i-gnome-it.jpg", material: MATERIALS.sample, length: 5, width: 10, height: 15, weight: 10)
lalique = Statue.create!(name: "lalique",user: martin, category: CATEGORIES.sample, surface: 40, description:  "haut de gamme ", price: 45, photo: "https://cdn.mycrazystuff.com/15836/nain-de-jardin-i-m-sexy-an-i-gnome-it.jpg", material: MATERIALS.sample, length: 5, width: 10, height: 15, weight: 10)
aphrodite = Statue.create!(name: "aphrodite",user: louis, category: CATEGORIES.sample, surface: 50, description:  "milieu de gamme ", price: 20, photo: "https://cdn.mycrazystuff.com/15836/nain-de-jardin-i-m-sexy-an-i-gnome-it.jpg", material: MATERIALS.sample, length: 5, width: 10, height: 15, weight: 10)
visage_grec = Statue.create!(name: "visage_grec",user: pierre, category: CATEGORIES.sample, surface: 70, description:  "entrée de gamme ", price: 10, photo: "https://cdn.mycrazystuff.com/15836/nain-de-jardin-i-m-sexy-an-i-gnome-it.jpg", material: MATERIALS.sample, length: 5, width: 10, height: 15, weight: 10)
le_cavalier = Statue.create!(name: "le_cavalier",user: martind, category: CATEGORIES.sample, surface: 77, description:  "milieu de gamme ", price: 40, photo: "https://cdn.mycrazystuff.com/15836/nain-de-jardin-i-m-sexy-an-i-gnome-it.jpg", material: MATERIALS.sample, length: 5, width: 10, height: 15, weight: 10)
leclair = Statue.create!(name: "leclair",user: antoine, category: CATEGORIES.sample, surface: 90, description:  "entrée de gamme ", price:  25, photo: "https://cdn.mycrazystuff.com/15836/nain-de-jardin-i-m-sexy-an-i-gnome-it.jpg", material: MATERIALS.sample, length: 5, width: 10, height: 15, weight: 10)
zig_zag = Statue.create!(name: "zig_zag",user: mika, category: CATEGORIES.sample, surface: 100, description: "haut de gamme ", price: 100, photo: "https://cdn.mycrazystuff.com/15836/nain-de-jardin-i-m-sexy-an-i-gnome-it.jpg", material: MATERIALS.sample, length: 5, width: 10, height: 15, weight: 10)
amazone = Statue.create!(name: "amazone",user: remi, category: CATEGORIES.sample, surface: 150, description: "milieu de gamme ", price: 90, photo: "https://cdn.mycrazystuff.com/15836/nain-de-jardin-i-m-sexy-an-i-gnome-it.jpg", material: MATERIALS.sample, length: 5, width: 10, height: 15, weight: 10)
sculpture_de_julie = Statue.create!(name: "sculpture_de_julie",user: olivier, category: CATEGORIES.sample, surface: 164, description: "entrée de gamme ", price: 1, photo: "https://cdn.mycrazystuff.com/15836/nain-de-jardin-i-m-sexy-an-i-gnome-it.jpg", material: MATERIALS.sample, length: 5, width: 10, height: 15, weight: 10)
tour_eiffel = Statue.create!(name: "tour_eiffel",user: valentin, category: CATEGORIES.sample, surface: 250 , description: "haut de gamme ", price: 200, photo: "https://cdn.mycrazystuff.com/15836/nain-de-jardin-i-m-sexy-an-i-gnome-it.jpg", material: MATERIALS.sample, length: 5, width: 10, height: 15, weight: 10)
